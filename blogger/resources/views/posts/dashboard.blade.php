                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#">More detail <i class="fa fa-arrow-circle-down"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/categories">More detail <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            ...
                            <a href="/tags">More detail <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6">
                    <div class="card card-stats">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#">More detail <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
