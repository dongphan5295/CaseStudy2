                  ...
                  <div class="tabulation-2 mt-4">
                                  ...
                                  <div class="tab-content bg-light rounded mt-2">
                                    <div class="tab-pane container p-0 active" id="home1">
                                        <p>Là một travel blogger chuyên về du lịch Việt Nam, Mình luôn mong muốn thông qua chia sẻ kinh nghiệm của mình có thể giúp mọi người đi du lịch Việt Nam một cách dễ dàng hơn, giúp hiểu rõ hơn về văn hóa, khám phá địa danh mới chứ không chỉ đi để check-in sống ảo.</p>
                                    </div>
                                    <div class="tab-pane container p-0 fade" id="home2">
                                        <p>"Sống một cuộc sống của người đam mê xê dịch dù còn nhiều khó khăn nhưng mình vui vẻ đón nhận tất cả mọi thứ như một phần tất yếu. Những trải nghiệm, con đường đã đi qua, những bạn bè đã gặp đều là trở thành một mảnh ghép trong bức tranh của cuộc đời. Mình hy vọng qua những bài chia sẻ sẽ khiến các bạn sẽ thêm yêu đất nước và con người Việt Nam hơn"</p>
                                    </div>
                                  </div>
                              </div>
                </div>
              ...
              <div class="testimony-wrap py-4">
                <div class="text">
                  ...
                  <div class="d-flex align-items-center">
                      <div class="user-img" style="background-image: url(images/about.jpg)"></div>
                      <div class="pl-3">
