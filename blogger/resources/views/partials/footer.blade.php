      ...
      <div class="row mb-5">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4 ml-md-5">
            ...
            <li><a href="{{route('blog.index')}}" class="py-1 d-block"><span class="ion-ios-arrow-forward mr-3"></span>Blog</a></li>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">28 Nguyen Tri Phuong St, Phu Hoi Ward, Hue City</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+84 123 456 789</span></a></li>
                  <li><a href="#"><span class="icon icon-envelope"></span><span class="text">dongdontcare@outlook.com</span></a></li>
                </ul>
              </div>
          </div>
        </div>
